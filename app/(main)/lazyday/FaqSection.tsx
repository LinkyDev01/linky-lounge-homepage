...
const faqs: Faq[] = [
  ...
  },
  {
    ...
    a: (
      <>
        <strong className={styles.answerStrong}>레이지선데이 미드나잇</strong>은 레이지데이 멤버들만 참여하는 네트워킹 파티입니다. 다른 시간대에 만나지 못한 멤버들과 새로운 인연을 쌓을 수 있습니다. 참가비는 1만원이며, 와인·음료가 무제한으로 제공됩니다.
      </>
    ),
  },
  {
