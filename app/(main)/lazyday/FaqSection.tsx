...
const faqs: Faq[] = [
  ...
  {
    q: "책은 어떤 기준으로 고르나요?",
    a: "철학서와 고전 소설을 함께 읽는 구조로 구성해요. 철학자들의 시선과 이론을 바탕으로 생각의 도구를 먼저 갖추고, 고전 소설 속 저자의 의도를 들여다보며 나의 이야기와 시선을 깊이 들여다볼 수 있도록요. 같은 부분을 읽더라도 더 밀도 있는 대화를 나눌 수 있는 이유입니다.",
  },
  {
    q: "모임에선 어떤 대화가 오가나요?",
    a: "모임장은 정답을 주는 사람이 아니라, 각자의 목소리가 나올 수 있도록 곁에서 돕는 역할이에요. 책의 설명을 돕고 대화의 흐름을 조율하며, 열린 질문을 통해 서로의 이야기가 자연스럽게 퍼지는 자리를 만듭니다.",
  },
  {
    q: "책을 다 읽고 와야 하나요?",
  ...
  },
  {
    ...
    a: "공간 운영, 모임 기획과 진행, 다과, 커뮤니티 운영이 포함됩니다. 직접 관리하는 약 30평 규모의 공간에서 진행하고, 일관된 모임 경험을 위하여 인터뷰부터 모임 당일 진행까지 모든 과정을 레이지데이가 함께하고 있습니다.",
  },
  {
    q: "모임은 어디에서 진행하나요?",
