 ...
 * 원본: preview/FeatureQuietSection.tsx (프리뷰 승인본을 픽셀 동일 이식, 2026-07-06).
 * 콰이어트 조판(좁은 단·중앙 정렬·명조·여백) + 본문 두 줄 페이드 컷(궁금증 장치).
 * 본문 조판은 종이책식(음절 줄바꿈+양쪽 정렬).
 * 텍스트는 확정 신규 원고 — 운영자 보완 원고가 오면 프리뷰 쌍과 함께 교체.
 * 기존 FeatureBoxSection은 고아 상태로 보존 (렌더에서만 교체).
 */
