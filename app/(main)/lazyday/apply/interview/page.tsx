...
const DAY_CONFIGS: Record<number, { startH: number; startM: number; endH: number; endM: number }> = {
  4: { startH: 19, startM: 30, endH: 22, endM: 30 },  // 목요일 19:30–22:30 KST
  0: { startH: 14, startM: 30, endH: 17, endM: 30 },  // 일요일 14:30–17:30 KST
}
const AVAILABLE_DAYS = Object.keys(DAY_CONFIGS).map(Number)  // [0, 4]
// ================================================================
...
export default function InterviewPage() {
  ...
  const availableMap = useMemo(() => {
    ...
    for (const cell of calDays) {
      if (!cell) continue
      if (!AVAILABLE_DAYS.includes(cell.dow)) continue
