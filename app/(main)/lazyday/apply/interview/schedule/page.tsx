          ...
          <div className={styles.header}>
            ...
            <div className={styles.headerSub}>
              ...
              <p className={styles.headerSubNote}>
                ✱ 3기 일정 및 참가비가 궁금하시면{" "}
                <button type="button" onClick={() => { setRef0Open(true); document.getElementById("ref0-section-phone")?.scrollIntoView({ behavior: "smooth", block: "start" }) }} className={styles.refLink}>
                  모집 안내
                </button>
                를 확인해보세요.
              </p>
