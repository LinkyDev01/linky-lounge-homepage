...
const QUESTIONS = [
  ...
  },
  {
    ...
    sub: "아직 답을 찾지 못한 질문이어도 좋고, 요즘 자꾸 곱씹게 되는 주제여도 좋습니다.",
    placeholder: "요즘의 화두를 편하게 적어주세요.",
  },
  {
    id: "q3",
    label: "Q3",
  ...
  },
  {
    ...
    sub: "후련함이든 조용한 여운이든, 돌아가는 길에 남아 있기를 바라는 마음을 편하게 적어주세요.",
    placeholder: "남기고 싶은 잔상이나 기분을 적어주세요.",
  },
]
