    ...
    return (
      <main className={styles.successPage}>
        ...
        <div className={styles.successInner}>
          ...
          <FadeUp delay={0.15}>
            <h1 className={styles.successTitle}>{SEASON.name} 모집이 마감되었습니다.</h1>
          </FadeUp>
          <FadeUp delay={0.3}>
            <p className={styles.successBody}>
              다음 기수 소식을 기다리고 계셨다면,
          ...
          <FadeUp delay={0.45}>
            <div className={styles.successActions}>
              <a href={`${base}/#notify`} className={styles.successPrimaryLink}>
  ...
  return (
    <main className={styles.applyPage} data-track-section="bookclub_apply_page">
      ...
      <div className={styles.container}>
        ...
        {/* 일정·장소 안내 — 표 형식 부활 + 장소 라인 (운영자 지시 2026-07-27 "기존에 없앤 것 다시 살려").
        ...
        <form onSubmit={handleSubmit} className={styles.form} noValidate>
            ...
            <div className={styles.faqItem}>
              ...
              {/* 상세 고지는 FAQ 라인 드롭다운 뒤 — 동의 시점에 즉시 열람 가능하므로 고지 요건 유지 */}
          ...
          {errors._form && (
            ...
            {step === 1 ? (
              ...
              /* 2단계에서 1단계로 돌아갈 수 있게 (운영자 지시 2026-07-27) — 입력값은 숨김 처리라 그대로 보존 */
