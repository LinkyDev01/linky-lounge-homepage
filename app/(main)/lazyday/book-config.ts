...
export const season2Config: SeasonConfig = {
  ...
  dateRange: "5.21 – 7.5",
  books: [
    { week: 1, weekLabel: "1회차", title: "", author: "", quotes: [], paragraphs: [], curatorNote: "", imagePath: "" },
    { week: 2, weekLabel: "2회차", title: "", author: "", quotes: [], paragraphs: [], curatorNote: "", imagePath: "" },
    { week: 3, weekLabel: "3회차", title: "", author: "", quotes: [], paragraphs: [], curatorNote: "", imagePath: "" },
