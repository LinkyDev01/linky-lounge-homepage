...
const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    paragraphs: [
      <>기수마다 고전 소설과 철학서를 교차해 읽습니다. 소설 속 인물들이 던진 모순을 철학자의 개념이 받아 이름을 붙입니다. 그렇게 벼려진 <strong>생각의 도구</strong>로 <strong>저자의 의도</strong>를, 인물의 맹점을 다시 들여다봅니다.</>,
      <>도구를 갖추고 다시 만난 문장은 처음과 전혀 다르게 읽힙니다. 같은 고전을 읽고도 <strong>대화의 밀도</strong>가 달라지는 이유입니다.</>,
    ],
  },
  {
    key: "questions",
    ...
    paragraphs: [
      ...
      <>&lsquo;저자의 진짜 의도는 무엇인가&rsquo;에서 시작해 책 속의 화두를 우리의 일상과 시선으로 친근하게 가져옵니다. 질문은 하나의 정답을 내리는 도구가 아니라, 저마다 깊이 감추어 두었던 <strong>생각의 결</strong>을 꺼내어 서로의 사유를 확인하는 통로가 됩니다.</>,
    ],
  },
  {
    key: "space",
