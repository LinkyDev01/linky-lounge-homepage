 ...
 * 실사이트 이식은 별도 승인 대기 (DECISIONS.md).
 */
...
const CHAPTERS: Chapter[] = [
  {
    key: "people",
    label: "낯선 시선의 자극을 기꺼이 받아들이는 분들과 함께합니다",
    paragraphs: [
      <>쉽게 공감하는 대화보다, <strong>문학과 철학, 예술</strong>의 한가운데서 서로 다른 시선과 부딪히는 순간을 기다리는 사람들이 모입니다. 함께하는 이들은 무색무취한 이야기에 고개만 끄덕이지 않습니다. 각자의 생각이 갈리는 지점은 나타나기 마련이고, 고립되어 있던 내 관점이 타인의 시선에 부딪혀 언제든 깨질 수 있음을 받아들이며 그 순간을 즐깁니다.</>,
  ...
  {
    key: "books",
    label: "고전 속 인물들의 복잡한 내면을 철학적 시선으로 풀어봅니다",
    paragraphs: [
      <>기수마다 고전 소설과 철학서를 교차하여 읽습니다. 소설 속 인물들이 던진 욕망과 모순에 철학자의 시선을 덧대어 봅니다. 그렇게 벼려진 <strong>철학</strong>이라는 관점으로 <strong>저자의 의도</strong>를, <strong>인물의 욕망</strong>을 통해 <strong>인간의 본성</strong>을 파헤쳐 봅니다.</>,
      <>철학이라는 관점을 갖추고 다시 만난 문장은 처음과 전혀 다르게 읽힙니다. 그래서 같은 고전을 읽고도, <strong>대화의 밀도</strong>가 달라집니다.</>,
    ],
  },
  {
    key: "questions",
    label: "질문을 통해 각자가 가진 사유의 궤적을 엿봅니다",
    paragraphs: [
      <>단순한 감상을 나누는 자리가 아닙니다. 대화는 텍스트의 인용에 단단히 발을 붙인 <strong>발제문</strong>에서 시작됩니다. 호스트는 대화의 중심을 지키며 우리가 길을 잃지 않도록 부드럽게 방향을 짚어 줍니다.</>,
      <>&lsquo;저자의 진짜 의도는 무엇인가&rsquo;에서 시작해, 책 속의 화두를 건네며 사유의 마찰을 빚어냅니다. 질문은 하나의 정답으로 수렴하기 위한 것이 아니라, 저마다 깊이 감추어 두었던 <strong>생각의 결</strong>을 꺼내어 서로의 사유를 확인하는 통로가 되어 줍니다.</>,
    ],
  },
  {
    key: "space",
    ...
    paragraphs: [
      <>텍스트와 대화에만 온전히 몰입할 수 있도록, 이야기를 무르익게 만드는 공간 <strong>링키라운지</strong>(사당역 10번 출구 도보 3분)에서 모입니다.</>,
