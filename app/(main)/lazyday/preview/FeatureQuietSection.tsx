...
const CHAPTERS: Chapter[] = [
  {
    ...
    paragraphs: [
      <><strong>문학과 철학, 예술</strong>의 한가운데서, 쉽게 공감하는 대화보다 서로 다른 시선과 부딪히는 순간을 기다리는 사람들이 모입니다. 함께하는 이들은 무색무취한 이야기에 고개만 끄덕이지 않습니다. 각자의 생각이 갈리는 지점은 나타나기 마련이고, 고립되어 있던 내 관점이 타인의 시선에 부딪혀 언제든 깨질 수 있음을 받아들이며 그 순간을 즐깁니다.</>,
  ...
  },
  {
    ...
    paragraphs: [
      ...
      <>&lsquo;저자의 진짜 의도는 무엇인가&rsquo;에서 시작해, 책 속의 화두를 건네며 <strong>사유의 마찰</strong>을 빚어냅니다. 질문은 하나의 정답으로 수렴하기 위한 것이 아니라, 저마다 깊이 감추어 두었던 <strong>생각의 결</strong>을 꺼내어 서로의 사유를 확인하는 통로가 되어 줍니다.</>,
    ],
  },
  {
    key: "space",
