...
const CHAPTERS: Chapter[] = [
  {
    key: "people",
    label: "낯선 시선의 자극을 기꺼이 받아들이는 분들과 함께",
    paragraphs: [
      <>읽고 나눕니다. 쉽게 공감하는 대화보다, <strong>문학과 철학, 예술</strong>의 한가운데서 서로 다른 시선과 부딪히는 순간을 기다리는 사람들이 모입니다. 함께하는 이들은 무색무취한 이야기에 고개만 끄덕이지 않습니다. 각자의 생각이 갈리는 지점은 나타나기 마련이고, 고립되어 있던 내 관점이 타인의 시선에 부딪혀 언제든 깨질 수 있음을 받아들이며 그 순간을 즐깁니다.</>,
  ...
  },
  {
    ...
    paragraphs: [
      <>풀어봅니다. 기수마다 고전 소설과 철학서를 교차하여 읽고, 소설 속 인물들이 던진 욕망과 모순에 철학자의 시선을 덧대어 봅니다. 그렇게 벼려진 <strong>철학</strong>이라는 관점으로 <strong>저자의 의도</strong>를, <strong>인물의 욕망</strong>을 통해 <strong>인간의 본성</strong>을 파헤쳐 봅니다.</>,
  ...
  },
  {
    ...
    paragraphs: [
      <>사유의 밀도를 높입니다. 단순한 감상을 나누는 자리가 아니라, 대화는 텍스트의 인용에 단단히 발을 붙인 <strong>발제문</strong>에서 시작됩니다. 호스트는 대화의 중심을 지키며 우리가 길을 잃지 않도록 부드럽게 방향을 짚어 줍니다.</>,
  ...
  },
  {
    ...
    paragraphs: [
      <>이야기가 무르익도록, <strong>링키라운지</strong>(사당역 10번 출구 도보 3분)에서 모입니다.</>,
