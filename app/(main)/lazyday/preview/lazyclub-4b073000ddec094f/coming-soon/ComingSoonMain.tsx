 ...
 *   3.75s    LAZY 동그라미 — 완성 배열을 1.25s 보여준 뒤 (라운드 50)
 *   4.0s     CLUB 동그라미 (다시 0.25s 텀) — 글자 확정과 동시에 그리지 않는다
 *   4.0–4.5s 정지 유지
 *   4.5s     최종 상태 — 내비·푸터가 색을 되찾아 노출 (페이드 없이 즉시)
 *
...
const T = {
  ...
  CAP_LAZY: 3750, // LAZY 동그라미 — 완성 배열을 1.25s 보여준 뒤 (라운드 50)
  CAP_CLUB: 4000, // CLUB 동그라미 (다시 0.25s)
  END: 4500, // 최종 상태 — 내비·푸터 노출, 고정
}
