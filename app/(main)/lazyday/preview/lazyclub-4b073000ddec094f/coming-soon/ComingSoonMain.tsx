 ...
 *   4.25s    LAZY 동그라미 — 완성 배열을 1.25s 보여준 뒤
 *   4.5s     CLUB 동그라미 (다시 0.25s 텀) — 글자 확정과 동시에 그리지 않는다
 *   4.5–5.0s 정지 유지
...
const T = {
  ...
  CAP_LAZY: 4250, // LAZY 동그라미 — 완성 배열을 1.25s 보여준 뒤
  CAP_CLUB: 4500, // CLUB 동그라미 (다시 0.25s)
  END: 5000, // 최종 상태 — 내비·푸터 노출, 고정
}
