 ...
 *   3.25s    LAZY 동그라미 — 완성 배열을 0.75s 보여준 뒤 (라운드 49)
 *   3.5s     CLUB 동그라미 (다시 0.25s 텀) — 글자 확정과 동시에 그리지 않는다
 *   3.5–4.0s 정지 유지
 *   4.0s     최종 상태 — 내비·푸터가 색을 되찾아 노출 (페이드 없이 즉시)
 *
...
const T = {
  ...
  CAP_LAZY: 3250, // LAZY 동그라미 — 완성 배열을 0.75s 보여준 뒤 (라운드 49)
  CAP_CLUB: 3500, // CLUB 동그라미 (다시 0.25s)
  END: 4000, // 최종 상태 — 내비·푸터 노출, 고정
}
