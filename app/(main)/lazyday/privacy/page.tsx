      ...
      <div className={styles.container}>
        ...
        <Article title="제1조 (개인정보의 처리 목적)">
          ...
          <ol className={styles.clauseList}>
            ...
            <li>회원 가입 및 관리: 소셜 계정(카카오·구글) 로그인을 통한 회원 식별, 본인이 한 주문·신청 내역의 조회 제공, 회원 프로필 표시</li>
          ...
          <ol className={styles.clauseList}>
            <li>수집 항목
              <ol className={styles.itemList}>
                ...
                <li>회원 가입·로그인 시(소셜 계정 연동): 이름(소셜 계정의 닉네임), 이메일 주소, 프로필 사진 — 모두 회원이 소셜 계정 동의 화면에서 선택적으로 동의한 항목만 전달받으며, 동의하지 않아도 로그인과 서비스 이용에 제한이 없다. 프로필 사진은 이미지 파일을 저장하지 않고 소셜 계정이 제공하는 주소만 보관한다.</li>
              </ol>
            </li>
        ...
        <Article title="제12조 (개인정보처리방침의 변경)">
          <p className={styles.clause}>
            이 개인정보처리방침은 2026년 9월 2일부터 적용된다. 내용의 추가·삭제 및 수정이 있을 경우 시행 7일 전부터
          ...
          <p className={styles.clause}>
            개정 고지일: 2026년 9월 2일 (회원 가입·로그인 관련 조항 신설 — 제1조 처리 목적, 제2조 수집 항목·수집 방법, 제3조 보유 기간) / 종전 방침 시행일: 2026년 9월 1일
          </p>
        </Article>
      </div>
    </main>
