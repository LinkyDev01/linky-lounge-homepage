      ...
      <div className={styles.container}>
        ...
        <Article title="제2조 (수집하는 개인정보의 항목 및 수집 방법)">
          <ol className={styles.clauseList}>
            ...
            <li>수집 방법: 웹사이트 신청 폼(lazyday-bookclub.com, lazy-club.com, linkylounge.com), 전화·서면 인터뷰, 소셜 계정(카카오·구글) 로그인 연동</li>
          </ol>
        </Article>
        ...
        <Article title="제12조 (개인정보처리방침의 변경)">
          ...
          <p className={styles.clause}>
            개정 고지일: 2026년 9월 3일 (회원 항목 구체화 — 제2조에 소셜 계정 식별자와 카카오·구글별 제공 항목 명시, 제1조에 운영자 계정 확인 목적, 제5조·제6조 Supabase 위탁 범위에 회원 정보·로그인 인증 추가, 제7조에 로그인 세션 쿠키) / 종전 방침 시행일: 2026년 9월 2일 (회원 가입·로그인 관련 조항 신설)
          </p>
        </Article>
      </div>
    </main>
