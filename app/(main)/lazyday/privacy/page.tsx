      ...
      <div className={styles.container}>
        ...
        <Article title="제6조 (개인정보의 국외 이전)">
          ...
          <ol className={styles.clauseList}>
            ...
            <li>Supabase, Inc. (미국)
              <ol className={styles.itemList}>
                <li>이전 항목: 이름, 휴대전화번호, 주문번호 및 결제 승인 정보, 신청 내역 / 이전 시기·방법: 신청·결제 시 정보통신망을 통한 전송</li>
                <li>이용 목적: 주문·신청 정보의 저장·관리(처리위탁) / 보유 기간: 제3조의 보유 기간 종료 시까지</li>
        ...
        <Article title="제12조 (개인정보처리방침의 변경)">
          <p className={styles.clause}>
            이 개인정보처리방침은 2026년 9월 1일부터 적용된다. 내용의 추가·삭제 및 수정이 있을 경우 시행 7일 전부터
            웹사이트를 통해 고지한다. 다만 이번 개정과 같이 이미 이용 중인 수탁자를 사실대로 알리는 등
            정보주체에게 불리하지 않은 변경은 고지와 동시에 시행한다.
          </p>
          <p className={styles.clause}>
            개정 고지일: 2026년 9월 1일 (제5조·제6조에 데이터베이스 호스팅 수탁자 추가, 제3조 3호에 마케팅 활용 정보의 보유 항목 명시) / 종전 방침 시행일: 2026년 8월 11일
          </p>
        </Article>
      </div>
    </main>
