...
export const SEASON = {
  ...
  /** (2026-09-08) 4기 전체 마감 — 남아 있던 토요일 오전 반도 closed. 배열은 그대로 두어
   *  월력 마커·시트 기록이 유지되고, 화면엔 전부 취소선·옅은 색으로 보인다. */
  days: [
    { label: "토요일", time: "10:30–13:30", closed: true },
  ...
  unavailableDaySlots: [
    { label: "토요일 오전", time: "10:30–13:30", closed: true },
    { label: "화요일", time: "19:30–22:30", closed: true },
    { label: "수요일", time: "19:30–22:30", closed: true },
