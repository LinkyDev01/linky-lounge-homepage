...
export const SEASON = {
  ...
  /** 정규모임(1–4회차) 일정 — dates는 days와 같은 순서(**화·수·일**). 격주, 회차 시작 = 수요일이라
   *  각 행의 화요일 날짜가 수·일보다 늦다 (운영자 지시 2026-07-27) */
  sessions: [
    { label: "1회차", dates: ["9/15", "9/9", "9/13"] },
    { label: "2회차", dates: ["9/29", "9/23", "9/27"] },
    { label: "3회차", dates: ["10/13", "10/7", "10/11"] },
    { label: "4회차", dates: ["10/27", "10/21", "10/25"] },
  ] as SeasonSession[],
  ...
  /** 안내 문구 */
  regularNote: "1–4회차 · 9월 9일부터 격주, 화·수·일 선택",
