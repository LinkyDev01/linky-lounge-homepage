...
/** 전송이 끝내 안 될 때의 안내 — "복사 → 카카오톡으로 전달"이라는 맥락을 링크보다 먼저
 *  전달한다 (운영자 지시 2026-08-06). 링크 라벨은 '문의'가 아니라 '제출'.
 *  ⚠ 즉시 접수를 약속하지 않는다 — 전달 후 확인·연락까지가 우리가 보장하는 범위
 *  (운영자 정정 2026-08-06: "대신 접수가 아니라 순차 확인 후 연락"). */
export const KAKAO_SUBMIT_GUIDE =
  "계속 안 되면 아래 버튼으로 내용을 복사해 카카오톡으로 보내주세요. 순차적으로 확인한 뒤 연락드릴게요."
