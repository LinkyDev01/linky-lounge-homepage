...
const IconKakao = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M12 3C6.477 3 2 6.477 2 10.8c0 2.7 1.65 5.08 4.14 6.54L5.1 20.7a.3.3 0 0 0 .43.34l4.07-2.7A11.6 11.6 0 0 0 12 18.6c5.523 0 10-3.477 10-7.8S17.523 3 12 3z" />
  </svg>
)
...
export default function LoungeInfoPage() {
  ...
  const checklistItems = [
    ...
    <><strong className={styles.checkoutTextStrong}>쓰레기 분리수거 &amp; 설거지</strong> <span className={styles.checkoutRequired}>필수</span></>,
          ...
          <div className={styles.section}>
            ...
            <div className={styles.contactRow}>
              <a href="tel:0507-1472-5790" className={styles.contactChip}>
                <span className={styles.contactChipIcon}><IconPhone /></span>
              ...
              <a href="mailto:linkylounge@gmail.com" className={styles.contactChip}>
                <span className={styles.contactChipIcon}><IconMail /></span>
