...
// ================================================================
// ⚠️ 레거시 미러 (2026-07-29 확인): 현재 Vercel INTERVIEW_GAS_URL은 이 스크립트가
//    아니라 **통합 스크립트(gas/linkyincdev-main.gs, 시트 바인딩 프로젝트)** 배포를
//    가리킨다 — apply/oneday/notify/admin_block 등 모든 계약이 통합본에 있음.
//    인터뷰·admin 관련 수정은 linkyincdev-main.gs에 할 것. 이 파일은 참고용 보존.
// ================================================================
// 배포 방법:
