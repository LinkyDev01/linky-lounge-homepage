...
//
// ⚠ 채도 0.85 · 대비 0.97 보정 대상 (CSS 필터 금지 — 운영자 지시):
//   - space: 지시 문면은 '두 번째(books)'였으나 근거(프로젝터 화면의 청록)에 해당하는
//     사진이 4번(라운지 프로젝터 컷)이어서 space에 적용 (2026-07-28 재해석)
//   - people: 운영자 재편집본(라운지 컷)이 "채도가 꽤나 있으니" 동일 보정 (2026-07-28)
...
/** 채도·대비 보정 대상 (헤더 주석 참조) */
const TONE_FIX_KEYS = ["people", "space"]
